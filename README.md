...
[![NPM](https://nodei.co/npm/fontnik.png?compact=true)](https://nodei.co/npm/fontnik/) [![Build Status](https://secure.travis-ci.org/mapbox/node-fontnik.png)](https://travis-ci.org/mapbox/node-fontnik)
